  ...
  return (
    <header className="header">
      <div className="container padding justify-space-between align-center">
        <div className="justify-space-between combiner-row">
          <div className="logo">
            <svg
              className="logo__svg"
              width="32"
          ...
          >
            <span className="burger-button__line burger-button__top-line"></span>
            <span className="burger-button__line burger-button__middle-line"></span>
            <span className="burger-button__line burger-button__bottom-line"></span>
          </button>
        </div>
        <div className="combiner">
          {burgerClicked ? (
            <nav className="linkset_mobile">
              <NavLinks />
            </nav>
          ) : null}
