    ...
    <div className='home-page'>
      <div className="container-1440">
        <div className="container-with-bg-img padding">
          <div className="left-col">
            <h1 className="home-page__header">Choose to be <br /> Canadian</h1>
            <div className="search-form-label">Register .CA</div>
            <form className="search-form" action="">
              <input className="search-form__input" type="text" placeholder='Start here by typing a domain name or a keyword'/>
              <button className="search-form__button">
                <svg className="search-form__button-svg" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className='home-page__intoduction'>
              ...
              We manage .CA domains on behalf of all Canadians and work
              every day to build a better online Canada.
            </p>
          </div>
      ...
      <div className="popular-domains">
        <div className="container-col center-col padding">
          <h2 className="popular-domains__header">Popular Domain Name Promos & Offers</h2>
          <p className="popular-domains__p">
            Register cheap domains at the best prices you can find on the internet
          </p>
          <div className="popular-domains__cards">
            <div className="container allow-wrap justify-space-between">
              { domainCards.map((card) =>
                <DomainCard label={card.label} domainName={card.domainName} price={card.price}/>
              )}
            </div>
          </div>
          <a href="#" className="view-all-link">
            <span className="view-all-link__text">View All Domain Extensions</span>
            <svg className="view-all-link__svg" width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M5.86865 5.26567L1.28115 9.89067C1.13428 10.0375 0.896777 10.0375 0.749902 9.89067L0.131152 9.27192C-0.0157227 9.12504 -0.0157227 8.88754 0.131152 8.74067L3.83428 5.00004L0.131152 1.25942C-0.0157227 1.11255 -0.0157227 0.875048 0.131152 0.728173L0.749902 0.109424C0.896777 -0.0374511 1.13428 -0.0374511 1.28115 0.109424L5.86865 4.73442C6.01553 4.88129 6.01553 5.11879 5.86865 5.26567Z" fill="#0088CC"/>
            </svg>
          </a>
        </div>
      </div>
          ...
          <p className="we-are__p">
            ...
            <div className="trust-and-privacy container justify-space-between">
              <div className="trust-and-privacy__block">
                <span className="trust-and-privacy__label">Trust the experts in domain registration!</span>
                <p className='trust-and-privacy__text'>
                  Among the first Dot-Ca registrars certified in 2000 and
                  ICANN accredited since 2005, our secure and robust system will
                  protect one of your most valuable assets: Your Domain Name.
                </p>
              </div>

              <div className="trust-and-privacy__block">
                <span className="trust-and-privacy__label">Privacy by default!</span>
                <p className='trust-and-privacy__text'>
                  Whois privacy can protect you against identity theft, spammers,
                  hackers and other threats on the web. Every domain registered
                  with us gets the Whois privacy service at no extra charge!
                </p>
              </div>
            </div>
      ...
      <div className="personal-support container-1440">
        <div className="container-with-bg-img padding">
          <div className="left-col">
            <span className='personal-support__header'>Unparalleled Personal Support</span>
            <p className='personal-support__text'>
              When you contact us, you get quick and direct access to
              our knowledgable staff with no long hold times. Get the
              answers you want without the hassle!
            </p>
          </div>
      ...
      <div className="reviews padding">
        <h1 className="reviews__header">We Are Loved By Users And Clients Worldwide</h1>
        <p className="reviews__text">Only those who risk going too far can possibly find out how far one can go.</p>
        
        <div className="reviews__cards">
          <div className="reviews__card">
            <div className="reviews__rate">
              <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.37346 0.695722L6.81029 5.86696L1.07553 6.69889C0.0471213 6.8473 -0.365027 8.10887 0.380766 8.83144L4.52973 12.8544L3.54842 18.5373C3.37179 19.5645 4.45908 20.3339 5.36973 19.8535L10.5 17.1702L15.6303 19.8535C16.5409 20.33 17.6282 19.5645 17.4516 18.5373L16.4703 12.8544L20.6192 8.83144C21.365 8.10887 20.9529 6.8473 19.9245 6.69889L14.1897 5.86696L11.6265 0.695722C11.1673 -0.226039 9.83664 -0.237757 9.37346 0.695722Z" fill="#FFA900"/>
              </svg>
              <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.37346 0.695722L6.81029 5.86696L1.07553 6.69889C0.0471213 6.8473 -0.365027 8.10887 0.380766 8.83144L4.52973 12.8544L3.54842 18.5373C3.37179 19.5645 4.45908 20.3339 5.36973 19.8535L10.5 17.1702L15.6303 19.8535C16.5409 20.33 17.6282 19.5645 17.4516 18.5373L16.4703 12.8544L20.6192 8.83144C21.365 8.10887 20.9529 6.8473 19.9245 6.69889L14.1897 5.86696L11.6265 0.695722C11.1673 -0.226039 9.83664 -0.237757 9.37346 0.695722Z" fill="#FFA900"/>
              </svg>
            ...
            <div className="reviews__commentator">
              Georges Embolo
            </div>
